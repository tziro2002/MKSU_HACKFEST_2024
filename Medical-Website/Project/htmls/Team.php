            ...
            <div class="row top-padding">
                <div class="col centred ">
                    ...
                    <p class="team-members-description">
                        <b class="Designation"> Team lead</b>Hi! We are here to help you and always open to connect!
                    </p>
                </div>
                <div class="col order centred">
                    ...
                    <div class="team-member-name-size">
                        faith njeri and linda macharia
                    </div>
                    <p class="team-members-description">
                        <b class="Designation"> Web Developers</b>Hi! We are here to help you and always open to connect!
                    </p>
                </div>
                <div class="col order-1 centred ">
                    <div class="round size-of-external-div">
                        <img class="team-members-image-size round  hover-color size-on-hover rgba-blue-strong"  src="C:\xampp\htdocs\Medical-Website\Project\resources\faith.jpeg"/>
                    </div>
                    <div class="team-member-name-size">
                       brian kipkoech and patrick alunya
                    </div>
                    <p class="team-members-description">
                        <b class="Designation"> project managers</b>Hi! We are here to help you and always open to connect!
                    </p>
                </div>
            </div>
        </div>
