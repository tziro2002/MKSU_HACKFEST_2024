...
<body>
    ...
    <div class="main-w3layouts-form ">
        ...
        <form action="pharmacy_login_action.php" method="post">
            <div class="fields-w3-agileits">
                <span class="fa fa-user" aria-hidden="true"></span>
                <input type="email" name="email1" required="" placeholder="Email" value="<?php if(isset($_COOKIE["email1"])){ echo $_COOKIE["email1"];}?>"/>
            </div>
            <div class="fields-w3-agileits">
